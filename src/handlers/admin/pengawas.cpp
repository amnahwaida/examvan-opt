...
Response pengawas_exams(const Request& req){
  ...
  if(middleware::is_protobuf_accept(req)){
    examvan::v1::PengawasExamList pb; pb.set_success(true); pb.set_is_privileged(true); pb.set_page(1); pb.set_per_page(10);
...
#endif
  Response r; r.json(200,"{\"success\":true,\"exams\":[],\"is_privileged\":true,\"page\":1,\"per_page\":10,\"total\":0,\"total_pages\":0,\"stats\":{\"total_exams\":0,\"active_exams\":0,\"total_students\":0,\"total_submitted\":0}}"); return r;
}
